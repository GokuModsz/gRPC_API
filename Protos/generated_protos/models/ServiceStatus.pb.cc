...
const uint32_t TableStruct_models_2fServiceStatus_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::TestApiGrpc::Protos::models::ServiceStatus, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::TestApiGrpc::Protos::models::ServiceStatus, _impl_.is_success_),
  PROTOBUF_FIELD_OFFSET(::TestApiGrpc::Protos::models::ServiceStatus, _impl_.error_message_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::TestApiGrpc::Protos::models::ServiceStatus)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::TestApiGrpc::Protos::models::_ServiceStatus_default_instance_._instance,
};

const char descriptor_table_protodef_models_2fServiceStatus_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\032models/ServiceStatus.proto\022\031TestApiGrp"
  "c.Protos.models\":\n\rServiceStatus\022\022\n\nis_s"
  "uccess\030\001 \001(\010\022\025\n\rerror_message\030\002 \001(\tb\006pro"
  "to3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_models_2fServiceStatus_2eproto = {
    false, false, 123, descriptor_table_protodef_models_2fServiceStatus_2eproto,
...
ServiceStatus::ServiceStatus(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:TestApiGrpc.Protos.models.ServiceStatus)
}
ServiceStatus::ServiceStatus(const ServiceStatus& from)
  ...
  // @@protoc_insertion_point(copy_constructor:TestApiGrpc.Protos.models.ServiceStatus)
}
...
ServiceStatus::~ServiceStatus() {
  // @@protoc_insertion_point(destructor:TestApiGrpc.Protos.models.ServiceStatus)
...
// @@protoc_insertion_point(message_clear_start:TestApiGrpc.Protos.models.ServiceStatus)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "TestApiGrpc.Protos.models.ServiceStatus.error_message"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* ServiceStatus::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:TestApiGrpc.Protos.models.ServiceStatus)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_error_message().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "TestApiGrpc.Protos.models.ServiceStatus.error_message");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:TestApiGrpc.Protos.models.ServiceStatus)
  return target;
}

size_t ServiceStatus::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:TestApiGrpc.Protos.models.ServiceStatus)
  size_t total_size = 0;
...
void ServiceStatus::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:TestApiGrpc.Protos.models.ServiceStatus)
...
// @@protoc_insertion_point(class_specific_copy_from_start:TestApiGrpc.Protos.models.ServiceStatus)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::TestApiGrpc::Protos::models::ServiceStatus*
Arena::CreateMaybeMessage< ::TestApiGrpc::Protos::models::ServiceStatus >(Arena* arena) {
  return Arena::CreateMessageInternal< ::TestApiGrpc::Protos::models::ServiceStatus >(arena);
}
