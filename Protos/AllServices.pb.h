...
#ifndef GOOGLE_PROTOBUF_INCLUDED_AllServices_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_AllServices_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_AllServices_2eproto
...
struct TableStruct_AllServices_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AllServices_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::TEST_API_GRPC::ServiceStatus* Arena::CreateMaybeMessage<::TEST_API_GRPC::ServiceStatus>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace TEST_API_GRPC {
...
class ServiceStatus final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:TEST_API_GRPC.ServiceStatus) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "TEST_API_GRPC.ServiceStatus";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:TEST_API_GRPC.ServiceStatus)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_AllServices_2eproto;
};
// ===================================================================
...
inline bool ServiceStatus::is_success() const {
  // @@protoc_insertion_point(field_get:TEST_API_GRPC.ServiceStatus.is_success)
...
inline void ServiceStatus::set_is_success(bool value) {
  ...
  // @@protoc_insertion_point(field_set:TEST_API_GRPC.ServiceStatus.is_success)
}
...
inline const std::string& ServiceStatus::error_message() const {
  // @@protoc_insertion_point(field_get:TEST_API_GRPC.ServiceStatus.error_message)
...
void ServiceStatus::set_error_message(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.error_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:TEST_API_GRPC.ServiceStatus.error_message)
}
inline std::string* ServiceStatus::mutable_error_message() {
  std::string* _s = _internal_mutable_error_message();
  // @@protoc_insertion_point(field_mutable:TEST_API_GRPC.ServiceStatus.error_message)
  return _s;
}
...
inline std::string* ServiceStatus::release_error_message() {
  // @@protoc_insertion_point(field_release:TEST_API_GRPC.ServiceStatus.error_message)
...
inline void ServiceStatus::set_allocated_error_message(std::string* error_message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:TEST_API_GRPC.ServiceStatus.error_message)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_AllServices_2eproto
